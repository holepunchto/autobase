...
test('upgrade - do not proceed', async t => {
  ...
  t.is(a0.view.data.flushedLength, 3)
  t.is(b0.view.data.flushedLength, 3)
...
test('upgrade - proceed', async t => {
  ...
  t.is(b1.view.data.flushedLength, 4)
})
...
test('upgrade - consensus', async t => {
  ...
  t.is(b0.view.data.flushedLength, 3) // should not advance
...
test.skip('upgrade - consensus 3 writers', async t => {
  ...
  t.is(a1.view.data.flushedLength, 3)
  t.is(b0.view.data.flushedLength, 3)
  t.is(c0.view.data.flushedLength, 3)
  ...
  t.is(await b0.view.version.get(b0.view.version.flushedLength - 1), 0)
  ...
  t.is(b1.view.data.flushedLength, 3)

  await confirm([a1, b1])

  t.is(b1.view.data.flushedLength, 5) // majority can continue
  t.is(await b1.view.version.get(b1.view.version.flushedLength - 1), 1)
})
...
test('upgrade - writer cannot append while behind', async t => {
  ...
  t.is(a1.view.data.flushedLength, 5)
  t.is(b1.view.data.flushedLength, 5)
})
...
test('upgrade - onindex hook', async t => {
  ...
  const b0 = createBase(s2, a0.bootstrap, t, {
    ...
    onindex: async () => {
      ...
      if (!view.flushedLength) return
      bversion = await view.get(view.flushedLength - 1)
    }
  })
  ...
  const a1 = createBase(s1, a0.bootstrap, t, {
    ...
    onindex: async () => {
      ...
      if (!view.flushedLength) return
      aversion = await view.get(view.flushedLength - 1)
    }
  })
...
test('autobase upgrade - do not proceed', async t => {
  ...
  t.is(a0.view.flushedLength, 3)
  t.is(b0.view.flushedLength, 3)
...
test('autobase upgrade - consensus', async t => {
  ...
  t.is(a1.view.flushedLength, 4)
  t.is(b0.view.flushedLength, 4)

  t.is(a1.system.version, version)
  t.is(b0.system.version, version)

  t.is(b0.view.flushedLength, 4) // should not advance
...
test('autobase upgrade - consensus 3 writers', async t => {
  ...
  t.is(b0.view.flushedLength, 3) // should not advance
  ...
  t.is(b1.view.flushedLength, a1.view.flushedLength)

  await confirm([a1, b1])

  t.is(b1.view.flushedLength, 5) // majority can continue
...
test('autobase upgrade - downgrade', async t => {
  ...
  t.is(a1.view.flushedLength, 1)

  await a1.append({ data: 'version 1' })

  t.is(a1.view.flushedLength, 2)
...
test.skip('autobase upgrade - 3 writers always increasing', async t => {
  ...
  t.not(b2.view.flushedLength, 6)

  await confirm([a2, b2])
  t.is(a2.version, b2.version)

  t.is(b2.view.flushedLength, 6) // majority can continue
