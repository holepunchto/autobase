...
const Info = {
  preencode (state, m) {
    ...
    if (m.version >= 2) c.fixed32.preencode(state, m.entropy)
  },
  encode (state, m) {
    c.uint.encode(state, m.version)
    ...
    if (m.version >= 2) c.fixed32.encode(state, m.entropy)
  },
  decode (state) {
    const version = c.uint.decode(state)
...
const EncryptionInfo = {
  preencode (state, e) {
    c.uint.preencode(state, e.legacyBlocks)
  },
  encode (state, e) {
    c.uint.encode(state, e.legacyBlocks)
  },
  decode (state) {
    return {
      legacyBlocks: c.uint.decode(state)
    }
  }
}
...
const ManifestData = {
  preencode (state, d) {
    c.uint.preencode(state, 0)
    EncryptionInfo.preencode(state, d.encryption)
  },
  encode (state, d) {
    c.uint.encode(state, 0)
    EncryptionInfo.encode(state, d.encryption)
  },
  decode (state) {
    const version = c.uint.decode(state)
    ...
    return {
      version,
      encryption: EncryptionInfo.decode(state)
    }
  }
}
