...
class AutoStore {
  ...
  _freshCorePreload (indexerManifests, name, entropy) {
    ...
    return {
      manifest: this._createManifest(indexerManifests, name, null, MANIFEST_VERSION, entropy, [], null),
      exclusive: true,
      encryption: this.getEncryption(name)
    }
  }
  ...
  _freshSystemPreload (indexerManifests, entropy) {
    return {
      manifest: this._createSystemManifest(indexerManifests, null, MANIFEST_VERSION, entropy, null),
      exclusive: true,
