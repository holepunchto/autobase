  ...
  async _open () {
    ...
    for (const s of this.sessions) {
      if (s.snapshotted) {
        ...
        s._snapshotIndexedLength = this.indexedLength
      }
    }
  }
...
class LinearizedCoreSession extends ReadyResource {
  ...
  snapshot (opts) {
    ...
    if (this.snapshotted) {
      ...
      core._snapshotIndexedLength = this._snapshotIndexedLength
      core.tip = this.tip
    } else {
      core.snapshotLength = this.core.getLength()
      core._snapshotIndexedLength = this.core.indexedLength
  ...
  get indexedLength () {
    return this.snapshotted ? this._snapshotIndexedLength : this.core.indexedLength
  }
  ...
  async update () {
    ...
    if (this.snapshotted) {
      ...
      this._snapshotIndexedLength = this.core.indexedLength
    }
  }
