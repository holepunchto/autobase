...
const { ManifestData } = require('./messages')
...
module.exports = class Fork {
  ...
  async _upgrade () {
    ...
    this.entropy = this.system.getEntropy(this.indexers)
    ...
    await this.encryption.update(this.entropy)
    ...
    await this.system.fork(this.indexers, this.manifests, views, this.base)
