...
module.exports = class ApplyState extends ReadyResource {
  ...
  async _boot () {
    ...
    const genesisLength = this.system.core.manifest.prologue
      ? this.system.core.manifest.prologue.length
      : this.system.core.length
    const inf = await this.system.getIndexedInfo(genesisLength)
