...
module.exports = class ApplyState extends ReadyResource {
  ...
  async _flush (localNodes) {
    ...
    // do not commit state if we are about to fork
    if (this.pendingViews && !this.pendingFork) {
