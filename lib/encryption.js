...
module.exports = class AutobaseEncryption extends ReadyResource {
  ...
  _close () {
    if (this._initialising) {
      this._initReject(new Error('Encryption closed'))
      this._initialising = null
    }
  ...
  id () {
    return this.core ? this.core.length - 1 : -1
  }
  ...
  get (name) {
    ...
    const blindingKey = this.base.encryptionKey
  ...
  static async setSystemEncryption (base, core, opts) {
    ...
    core.setEncryption(encryption, opts)
