...
module.exports = class FastForward {
  constructor(
    base,
    key,
    { timeout = DEFAULT_OP_TIMEOUT, verified = true, minimum = DEFAULT_MIN_FF, force = false } = {}
  ) {
    this.base = base
    this.key = key
  ...
  async _ensureEncryption() {
    ...
    this.encryption = new EncryptionView(this.base, encCore, this.base.encryptionOpts)
