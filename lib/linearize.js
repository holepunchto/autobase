...
class OutputsBranch {
  constructor (cores, opts = {}) {
    ...
    this.operations = opts.operations || 0
  }
  ...
  clone () {
    return new OutputsBranch(this.cores, {
      ...
      snapshots: this.snapshots && this.snapshots.map(s => s.snapshot()),
...
class Update {
  ...
  clone () {
    ...
    return new Update(this.autobase, this.clock, this.applied, lastOutputs, latestOutputs, this.localOutput, {
...
class BranchSnapshot {
  ...
  copy (opts) {
    const clonedUpdate = this.lastUpdate && this.lastUpdate.clone()
