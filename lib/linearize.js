...
class BranchSnapshot {
  ...
  async _rebuild (clock) {
    ...
    this.lastUpdate = new Update(this.autobase, clock, applied, lastOutputs, this.lastOutputs)
...
class LinearizedCore extends EventEmitter {
  ...
  session (opts = {}) {
    if (!opts.snapshot && !opts.checkout) return this._snapshot.session({ ...this.opts, ...opts })
    if (opts.snapshot) {
